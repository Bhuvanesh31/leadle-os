...
def _make_wb() -> openpyxl.Workbook:
    ...
    row1 = [
        ...
        "Active",
        229856678,
        "ACoAAA2zVaYBQXGrEKQf8TU4u1pSCTjzT45lh2Y",
    ...
    row_sg = [
        ...
        "SG",
        "Singapore",
        "https://linkedin.com/company/gamma",
        "Logistics",
        "201-500",
